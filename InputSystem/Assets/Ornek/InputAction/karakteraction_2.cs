// GENERATED AUTOMATICALLY FROM 'Assets/Ornek/InputAction/karakteraction_2.inputactions'
...
public class @Karakteraction_2 : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @Karakteraction_2()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""karakteraction_2"",
    ""maps"": [
        {
            ""name"": ""Playercontrol"",
    ...
    {
        private @Karakteraction_2 m_Wrapper;
        public PlayercontrolActions(@Karakteraction_2 wrapper) { m_Wrapper = wrapper; }
